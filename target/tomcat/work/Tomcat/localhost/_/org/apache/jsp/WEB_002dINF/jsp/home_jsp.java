 ...
 * Generated at: 2019-04-21 13:19:23 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_shiro_005fprincipal_005f0(_jspx_page_context))
        return;
      out.write("</a> | \r\n");
      out.write("\t\t\t\t<a href=\"logout.do\"> 安全退出 </a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- 右侧  菜单栏 -->\r\n");
      ...
      out.write("\t\t\t    \t\t<ul>\r\n");
      out.write("\t\t\t    \t\t\t<li>\r\n");
      out.write("\t\t\t    \t\t\t\t<a href=\"javascript:void(0)\" onclick=\"goTabs('/sys/user/user','用户管理')\"><span>用户管理</span></a>\r\n");
      out.write("\t\t\t    \t\t\t\t\r\n");
      out.write("\t\t\t    \t\t\t</li>\r\n");
      out.write("\t\t\t    \t\t\t<li>\r\n");
      out.write("\t\t\t    \t\t\t\t<a href=\"javascript:void(0)\" onclick=\"goTabs('/sys/role/role','角色管理')\"><span>角色管理</span></a>\r\n");
      out.write("\t\t\t    \t\t\t\t\r\n");
      out.write("\t\t\t    \t\t\t</li>\r\n");
      out.write("\t\t\t    \t\t\t<!-- <li>\r\n");
      out.write("\t\t\t    \t\t\t\t<a href=\"javascript:void(0)\" onclick=\"goTabs('user/user')\"><span>菜单管理</span></a>\r\n");
      out.write("\t\t\t    \t\t\t</li> -->\r\n");
      out.write("\t\t\t    \t\t</ul>\r\n");
      out.write("\t\t\t    \t</li>\r\n");
      out.write("\t\t\t        <li>\r\n");
      out.write("\t\t\t\t\t\t<span>教学管理</span>\r\n");
      out.write("\t\t\t    \t\t<ul>\r\n");
      out.write("\t\t\t    \t\t\t<li>\r\n");
      out.write("\t\t\t    \t\t\t\t<a href=\"javascript:void(0)\" onclick=\"goTabs('teach/classes/classes','班级管理')\"><span>班级管理</span></a>\r\n");
      out.write("\t\t\t    \t\t\t\t\r\n");
      out.write("\t\t\t    \t\t\t</li>\r\n");
      out.write("\t\t\t    \t\t\t<li>\r\n");
      out.write("\t\t\t    \t\t\t\t<a href=\"javascript:void(0)\" onclick=\"goTabs('teach/student/student','学生管理')\"><span>学生管理</span></a>\r\n");
      out.write("\t\t\t    \t\t\t\t\r\n");
      out.write("\t\t\t    \t\t\t</li>\r\n");
      out.write("\t\t\t    \t\t</ul>\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t<span>博客管理</span>\r\n");
      out.write("\t\t\t    \t\t<ul>\r\n");
      out.write("\t\t\t    \t\t\t<li>\r\n");
      out.write("\t\t\t    \t\t\t\t<a href=\"javascript:void(0)\" onclick=\"goTabs('blogs/blogsType/blogs_type','类型管理')\"><span>类型管理</span></a>\r\n");
      out.write("\t\t\t    \t\t\t\t\r\n");
      out.write("\t\t\t    \t\t\t</li>\r\n");
      out.write("\t\t\t    \t\t\t<li>\r\n");
      out.write("\t\t\t    \t\t\t\t<a href=\"javascript:void(0)\" onclick=\"goTabs('blogs/blogs/blogs','博客管理')\"><span>博客管理</span></a>\r\n");
      out.write("\t\t\t    \t\t\t\t\r\n");
      out.write("\t\t\t    \t\t\t</li>\r\n");
      out.write("\t\t\t    \t\t</ul>\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
