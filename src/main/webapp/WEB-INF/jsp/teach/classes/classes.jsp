	...
	<script type="text/javascript">
	    ...
	    $(function(){
	    	$('#dg').datagrid({
		        ...
		        columns:[[
		            {checkbox:true,field:''},
		    		{field:'classId',title:'编号',width:100},
		    		{field:'className',title:'账号',width:100,editor:'textbox'},
		    		{field:'description',title:'描述',width:100,editor:'textbox'},
		    		{field:'classStart',title:'开班时间',width:200	
