	    ...
	    $(function(){
	    	$('#dg').datagrid({
		        ...
		        columns:[[
		    		...
		    		{field:'stuName',title:'学生姓名',width:100,editor:'textbox'},
		    		{field:'stuSex',title:'性别',width:50,editor:'textbox'},
		    		{field:'phone',title:'手机号',width:150,editor:'textbox'},
		    		{field:'idCard',title:'身份证号码',width:150,editor:'textbox'},
		    		{field:'email',title:'邮箱',width:150,editor:'textbox'},
		    		{field:'description',title:'描述',width:300,editor:'textbox'}
		        ]]
		    });
